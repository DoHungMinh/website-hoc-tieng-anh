    ...
    useEffect(() => {
        const fetchExams = async () => {
            try {
                ...
                // Sử dụng cache với TTL 10 phút cho danh sách đầy đủ
                const data = await fetchWithCache(
                    "/api/ielts?status=published&limit=20",
                    undefined,
                    "ielts-exams-list",
                    10 * 60 * 1000 // 10 phút
                );
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        Luyện tập với các đề thi IELTS chính
                                        thức
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="xl:col-span-2">
                        <div className="bg-white rounded-xl shadow-sm border p-6">
                            <div className="mb-6">
                                ...
                                <p className="text-gray-600">
                                    Chọn đề thi để bắt đầu luyện tập. Các đề thi
                                    được sắp xếp từ mới nhất.
                                </p>
                            </div>
