...
type ProfileTab = 'profile' | 'password' | 'courses' | 'progress' | 'achievements';
...
const UserProfile: React.FC<UserProfileProps> = ({ onBack }) => {
  ...
  const tabs = [
    ...
    { id: 'progress' as ProfileTab, label: 'Tiến độ học tập', icon: BarChart3 },
  ...
  const renderCoursesContent = () => (
    <div className="space-y-6">
      <div className="text-center py-12">
        ...
        <button className="bg-gradient-to-r from-green-500 to-lime-500 hover:from-green-600 hover:to-lime-600 text-white px-8 py-3 rounded-lg font-medium transition-all duration-200 transform hover:scale-105">
          Khám phá khóa học
        </button>
      </div>
    </div>
