...
export const API_ENDPOINTS = {
    ...
    ADMIN: {
        ...
        STATISTICS_REALTIME: "/admin/statistics/realtime",
        STATISTICS_USERS: "/admin/statistics/users",
        STATISTICS_USER_GROWTH: "/admin/statistics/user-growth",
        STATISTICS_RECENT_ACTIVITIES: "/admin/statistics/recent-activities",
    },
};
