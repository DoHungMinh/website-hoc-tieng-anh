            ...
            <div className={styles.mainArea}>
                                ...
                                {availableVoices.map((voice) => (
                                    <div
                                        ...
                                        className={`${styles.modelOption} ${
                                            selectedVoice === voice ? styles.modelOptionActive : ''
                                        }`}
                                        onClick={() => {
                ...
                <main className={styles.mainContent}>
                    ...
                    <div className={styles.voiceOrbContainer}>
                        <button
                            onClick={
                                recorder.state.isRecording ? handleStopRecording : handleStartRecording
                            }
                            disabled={isProcessing}
                            className={`${styles.voiceOrb} ${
                                recorder.state.isRecording ? styles.voiceOrbRecording : ''
                            } ${player.state.isPlaying ? styles.voiceOrbPlaying : ''} ${
                                isProcessing ? styles.voiceOrbProcessing : ''
                            }`}
                        >
                        ...
                        {/* Recording Time */}
                        {recorder.state.isRecording && (
                            <div className={styles.recordingTime}>{formatTime(recorder.state.recordingTime)}</div>
                        )}
                    </div>
                    ...
                    {player.state.duration > 0 && (
                        <div className={styles.audioPlayerFixed}>
                            <button
                                onClick={
                                    player.state.isPlaying ? player.controls.pause : player.controls.play
                                }
                            ...
                            <span className={styles.audioTime}>
                                {formatTime(Math.floor(player.state.currentTime))} /{' '}
                                {formatTime(Math.floor(player.state.duration))}
                            </span>
                        </div>
                    )}
                </main>
